...
#define ERROR_NO1H		"This enchant requires a one-handed weapon to be equipped!"
#define ERROR_NO2H		"This enchant requires a two-handed weapon to be equipped!"
#define ERROR_NOSHIELD	"This enchant requires a shield to be equipped!"
#define NO_2H			"You don't have a two-handed weapon equipped."
#define NO_1H			"You don't have a one-handed weapon equipped."
#define NO_SHIELD		"You don't have a shield equipped."
#define ERROR_1HOFFHAND "This enchant requires a one-handed weapon equipped in the off-hand!"
#define ERROROFFH		"Your off-hand is not a weapon."
        ...
        case 2: // Enchant 2H Weapon
            {
                ...
                if (!item)
                {
                    player->GetSession()->SendNotification(ERROR_NO2H);
                ...
                {
                    player->GetSession()->SendNotification(NO_2H);
                    player->PlayerTalkClass->SendCloseGossip();
                }
            }
            break;
        ...
        case 3: // Enchant Shield
            {
                ...
                if (!item)
                {
                    player->GetSession()->SendNotification(ERROR_NOSHIELD);
                    player->PlayerTalkClass->SendCloseGossip();
                    return false;
                }
                ...
                {
                    player->GetSession()->SendNotification(NO_SHIELD);
                    player->PlayerTalkClass->SendCloseGossip();
                }
            }
            break;
        ...
        case 13: //Enchant Off-Hand weapons
            {
                ...
                if(!item)
                {
                    player->GetSession()->SendNotification(ERROR_1HOFFHAND);
                    player->PlayerTalkClass->SendCloseGossip();
                    return false;
                }
                ...
                {
                    player->GetSession()->SendNotification(ERROROFFH);
                    player->PlayerTalkClass->SendCloseGossip();
                }
            }
            break;
        ...
        case 115:
            {
                ...
                if (!item)
                {
                    player->GetSession()->SendAreaTriggerMessage(ERROR_NO2H);
                    player->PlayerTalkClass->SendCloseGossip();
                    return false;
                }
                ...
                {
                    player->GetSession()->SendAreaTriggerMessage(NO_2H);
                    player->PlayerTalkClass->SendCloseGossip();
                }
            }
            break;
        ...
        case 118:
            {
                ...
                if(!item)
                {
                    player->GetSession()->SendAreaTriggerMessage(ERROR_NOSHIELD);
                    player->PlayerTalkClass->SendCloseGossip();
                    return false;
                }
                ...
                {
                    player->GetSession()->SendAreaTriggerMessage(NO_SHIELD);
                    player->PlayerTalkClass->SendCloseGossip();
                }						
            }
            break;
        ...
        case 205:
            {
                ...
                if(!item)
                {
                    player->GetSession()->SendAreaTriggerMessage(ERROR_1HOFFHAND);
                    player->PlayerTalkClass->SendCloseGossip();
                    return false;
                }
