...
class Morpher_Npc : public CreatureScript
{
    ...
    bool OnGossipHello(Player * pPlayer, Creature * pCreature)
    {
		...
		pPlayer->ADD_GOSSIP_ITEM(8, "Etherial", GOSSIP_SENDER_MAIN, 13);
		pPlayer->ADD_GOSSIP_ITEM(8, "Mad Scientist)", GOSSIP_SENDER_MAIN, 14);
		pPlayer->ADD_GOSSIP_ITEM(8, "Tatooed Man ", GOSSIP_SENDER_MAIN, 15);
    ...
    bool OnGossipSelect(Player * pPlayer, Creature * pCreature, uint32 sender, uint32 uiAction)
    {
        if (sender == GOSSIP_SENDER_MAIN)
        {
			...
			case 13:
				...
				pPlayer->SetFloatValue(OBJECT_FIELD_SCALE_X, 1);
				pPlayer->CLOSE_GOSSIP_MENU();
				pCreature->Whisper("You have been Morphed into a Etherial", LANG_UNIVERSAL, pPlayer);
				break;
			...
			case 15:
				...
				pPlayer->CLOSE_GOSSIP_MENU();
				pCreature->Whisper("You have been Morphed into a Tattooed Man", LANG_UNIVERSAL, pPlayer);
				break;
